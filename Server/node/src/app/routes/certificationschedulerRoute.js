module.exports = function(app){
    ...
    cron.schedule('0 0-23/4 1-31 * *', certificationscheduler.updateIntermediateCertification, {
        timezone: "Asia/Seoul"
    }); // 챌린지 중간 인증 추가
    ...
    cron.schedule('0 0 1-31 * *', certificationscheduler.updateChallengeSuccess, {
        timezone: "Asia/Seoul"
