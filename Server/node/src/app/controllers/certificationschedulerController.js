...
//                 // console.log(getChallengeCertification_0InfoRows[i].challengeCertificationStatus); // 챌린지 상태

//                 // var tempChallengeIdx = getChallengeCertification_0InfoRows[i].challengeIdx; // 챌린지 번호
//                 // var tempIntermediateStatus = getChallengeCertification_0InfoRows[i].challengeCertificationStatus; // 챌린지 상태
                
//                 // console.log(tempChallengeIdx); // number
//                 // console.log(tempIntermediateStatus); // string

//                 // if(tempChallengeIdx == i){
//                 //     if(tempIntermediateStatus!= '3'){
//                 //         excludingFailureStatusCount++;
//                 //     }
//                 // }
//             }
